...
expect(e2e.includes('FRXE Save uses media extraction directly'), 'E2E suite must cover extractor Save');
expect(e2e.includes('surfaces provider challenge'), 'E2E suite must cover user-solvable provider challenges');
